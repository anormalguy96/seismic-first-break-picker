...
## 6. Single-Command Pipeline Execution
...
## 9. Primary Output Artifacts

The principal artifacts generated by the verified workflow are listed below.
...
For a new reader, the most reliable sequence is:

1. read this README for the pipeline contract;
2. inspect `reports/evaluation/methodology_results_summary.md` for the verified results;
3. review `scripts/run_halfmile_pipeline.py` for the exact orchestration path; and
4. open the notebooks if interactive exploration is needed after the batch artifacts have been generated.
